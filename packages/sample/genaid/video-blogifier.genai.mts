...
def("TRANSCRIPT", transcript.srt.replace(/geni+\s*script/i, "GenAID"), { language: "srt" })
...
- "geniscript", "Janii iScript" (or variants) should be "GenAID"
- Mention GenAID in the title
