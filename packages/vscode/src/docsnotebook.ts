...
const NOTEBOOK_ID = "genaid"
const NOTEBOOK_TYPE = "genaid"
...
> = {
    markdown: {
        startMarker: "<!-- genaid output start -->",
        endMarker: "<!-- genaid output end -->",
    },
    mdx: {
        startMarker: "{/* genaid output start */}",
        endMarker: "{/* genaid output end */}",
...
function activateNotebookExecutor(state: ExtensionState) {
    ...
    controller.description = "GenAID interactive notebook"
