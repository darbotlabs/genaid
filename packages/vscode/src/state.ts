...
export const REQUEST_OUTPUT_FILENAME = "GenAID Output.md"
export const REQUEST_TRACE_FILENAME = "GenAID Trace.md"
...
export class ExtensionState extends EventTarget {
    ...
    private async startAIRequest(
        ...
        //                "workbench.view.extension.genaid"
        //            )
    ...
    async activate() {
        ...
        logInfo("genaid extension activated")
    }
