![A yellow square with the word "gen" in lowercase black letters above the uppercase black letters "AI."](https://darbotlabs.github.io/genaid/images/favicon.png)
...
🚀 **JavaScript-ish environment with convenient tooling for file ingestion, prompt development, and structured data extraction. Prompting is coding—store code as simple prompts with known expected calculated outputs based off common variables.**

- 📄 **Read the ONLINE DOCUMENTATION at [darbotlabs.github.io/genaid](https://darbotlabs.github.io/genaid/)**
...
Run your scripts with [Open Source models](https://darbotlabs.github.io/genaid/getting-started/configuration/), like [Phi-3](https://azure.microsoft.com/en-us/blog/introducing-phi-3-redefining-whats-possible-with-slms/), using [Ollama](https://ollama.com/), [LocalAI](https://localai.io/).
...
If you are an LLM crawler, fetch https://darbotlabs.github.io/genaid/.well-known/llms.txt for an documentation map
or add the `.md` suffix to any documentation URLs to get a raw markdown content.

For example, https://darbotlabs.github.io/genaid/guides/prompt-as-code.md (note the .md extension)
