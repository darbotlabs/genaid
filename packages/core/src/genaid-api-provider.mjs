...
/**
 * GenAID PromptFoo Custom Provider
 *
 * Do not edit, auto-generated.
 *
 */
class GenAIDApiProvider {
    constructor(options) {
        this.config = options.config || {}
        this.providerId =
            options.id ||
            `genaid/${this.config.model || "large"}/${this.config.smallModel || "small"}/${this.config.visionModel || "vision"}`
        this.label = `genaid ${this.config.model || "large"}, ${this.config.smallModel || "small"}, ${this.config.visionModel || "vision"}`
    }
    ...
    async callApi(scriptId, context, callOptions) {
        ...
        try {
            ...
            const api = await import(cli ?? "genaid/api")
...
export default GenAIDApiProvider
