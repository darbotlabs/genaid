...
/**
 * Converts a PromptyDocument into a script compatible with GenAID scripts.
 *
 ...
 *
 * Generates a script string by mapping chat roles and content into reusable GenAID script components:
 ...
 */
export function promptyToGenAID(doc: PromptyDocument): string {
