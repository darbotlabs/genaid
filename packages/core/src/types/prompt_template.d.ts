/**
 * GenAID Ambient Type Definition File
 * @version 0.0.0
 */
...
interface ExpansionVariables {
    ...
    /**
     * List of secrets used by the prompt, must be registered in `genaid`.
     */
...
interface HashOptions {
    ...
    length?: number
    /**
     * Include genaid version in the hash
     */
    version?: boolean
    /**
...
interface UserInterfaceHost {
     ...
     * Requires to [install playwright and dependencies](https://darbotlabs.github.io/genaid/reference/scripts/browser).
     * @link https://darbotlabs.github.io/genaid/reference/scripts/browser
     * @param url
     * @param options
     */
...
interface PromptHost
     ...
     * uses `GENAID_TEAMS_CHANNEL_URL` environment variable if `shareUrl` is not provided.
