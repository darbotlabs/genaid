...
/**
 * Convert GenAID connection info into prompt foo configuration
 * @param info
 */
...
function renderPurpose(script: PromptScript): string {
    ...
    trace.appendContent(
        `The prompt is written using GenAID (https://darbotlabs.github.io/genaid), a JavaScript-based DSL for creating AI prompts. The generated prompt will be injected in the 'env.files' variable.`
    )
