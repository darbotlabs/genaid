...
+ [87] -   Your organization may restrict the execution of GitHub Actions on pull requests.
[92] You can use the [defOutput](/genaid/reference/scripts/custom-output/) function
...
[29]     private folder() {
[30]         return dotGenaidPath("cache", this.name)
[31]     }
...
[3] import { dotGenaidPath, sha256string } from "./util"
...
[24] 
[25]     private folder() {
[26]         return dotGenaidPath("cache", this.name)
[27]     }
[28]     private path() {
