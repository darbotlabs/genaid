...
export const DOCS_URL = "https://darbotlabs.github.io/genaid"
export const TOOL_URL = DOCS_URL
export const TOOL_ID = "genaid"
export const GENAID_FOLDER = "." + TOOL_ID
export const CLI_JS = TOOL_ID + ".cjs"
export const GENAI_SRC = "genaid"
...
export const TRACE_NODE_PREFIX = "genaid/trace/"
export const EXTENSION_ID = "genaid.genaid-vscode"
...
export const NPM_CLI_PACKAGE = "genaid"
export const ICON_LOGO_NAME = "genaid-logo"
export const SARIFF_RULEID_PREFIX = "genaid/"
export const SARIFF_BUILDER_URL = "https://github.com/darbotlabs/genaid/"
...
export const DOT_ENV_GENAID_FILENAME = ".env.genaid"
...
export const PROMPTFOO_CACHE_PATH = ".genaid/cache/tests"
export const PROMPTFOO_CONFIG_DIR = ".genaid/config/tests"
...
export const TYPE_DEFINITION_BASENAME = "genaid.d.ts"
...
export const DOCS_CONFIGURATION_URL =
    "https://darbotlabs.github.io/genaid/getting-started/configuration/"
export const DOCS_CONFIGURATION_CONTENT_SAFETY_URL =
    "https://darbotlabs.github.io/genaid/reference/scripts/content-safety"
export const DOCS_DEF_FILES_IS_EMPTY_URL =
    "https://darbotlabs.github.io/genaid/reference/scripts/context/#empty-files"
export const DOCS_WEB_SEARCH_URL =
    "https://darbotlabs.github.io/genaid/reference/scripts/web-search/"
export const DOCS_WEB_SEARCH_BING_SEARCH_URL =
    "https://darbotlabs.github.io/genaid/reference/scripts/web-search/#bingn"
export const DOCS_WEB_SEARCH_TAVILY_URL =
    "https://darbotlabs.github.io/genaid/reference/scripts/web-search/#tavily"
...
export const GIT_IGNORE_GENAID = ".gitignore.genaid"
export const GIT_IGNORE_GENAI = ".gitignore.genai"
export const GENAIDIGNORE = ".genaidignore"
export const CLI_ENV_VAR_RX = /^genaid_var_/i
