...
$`
You are an expert at writing GenAID programs.

Generate 3 example genaid program that uses \`${api}\`.
...
`
defFileOutput("packages/auto/*.genai.mts", "Generated genaid programs")