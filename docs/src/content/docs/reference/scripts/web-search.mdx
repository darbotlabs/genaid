...
Add the [system.retrieval_web_search](https://github.com/darbotlabs/genaid/blob/main/packages/core/src/genaid/system.retrieval_web_search.genai.mjs) system script to register a [tool](/genaid/reference/scripts/tools) that uses `retrieval.webSearch`.
