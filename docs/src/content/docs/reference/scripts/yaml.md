...
The [parsers](/genaid/reference/scripts/parsers) also provide a lenient parser for YAML.
...
JSON schemas defined with [defSchema](/genaid/reference/scripts/schemas) can also be used to validate YAML data.
