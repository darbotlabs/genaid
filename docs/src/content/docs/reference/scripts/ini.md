---
title: INI
description: Learn how to parse and stringify INI files in GenAID with the
...
The [parsers](/genaid/reference/scripts/parsers) also provide a merciful parser for `.env`.
