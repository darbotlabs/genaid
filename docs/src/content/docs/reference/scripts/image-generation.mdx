...
GenAID support LLM providers with [OpenAI-compatible image generation APIs](https://platform.openai.com/docs/guides/images).

## Supported providers

You will need to configure a LLM provider that support image generation.

- [OpenAI](/genaid/getting-started/configuration/#openai)
- [Azure OpenAI](/genaid/getting-started/configuration/#azure-openai)
- [Azure AI Foundry](/genaid/getting-started/configuration/#azure-ai-inference)
