...
The IntelliSense provided by `genaid.g.ts` will assist in discovering the list of supported models.
...
:::tip
You can override the model from the [CLI](/genaid/reference/cli/)
:::
...
See `genaid.d.ts` in the sources for details.
