...
sidebar:
  order: 10
description: Learn how to use GenAID's retrieval utilities for content
...
GenAID provides various utilities to retrieve content and augment the prompt.
This technique is typically referred to as **RAG** (Retrieval-Augmentation-Generation) in the literature.

## Vector Search

GenAID provides various vector database to support embeddings (vector) search.
...
- Read more about [vector search](/genaid/reference/scripts/vector-search) and how to use it.
