...
GenAID provides a builtin support for [PromptFoo Red Team](https://www.promptfoo.dev/docs/red-team/).
...
If not specified, GenAID will let PromptFoo use the `default` set of plugins.
