...
You can specify a file location for the output file using the `--out-output` flag in the [run](/genaid/reference/cli/run) command.

```sh
genaid run ... --out-output ./output.md
```
