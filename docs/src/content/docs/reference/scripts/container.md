...
GenAID uses Docker to orchestrate the containers.

-   [Install docker](https://docs.docker.com/engine/install/)

## Start a container

Start by creating and starting a new container. GenAID will pull the container image on demand,
...
The [containerized tools](/genaid/guides/containerized-tools) guide shows how to use containers in tools to handle untrusted text securely.
