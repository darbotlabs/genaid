...
The GenAID Markdown Notebook is currently used to author the GenAID documentation.
...
The first step is to open the markdown file to edit using the GenAID notebook.

<Steps>

1.  In Visual Studio Code, right click on any Markdown (`.md`) or MDX file (`.mdx`)
2.  Select **Open With...**
3.  Select **GenAID Markdown Notebook**

</Steps>

## Run snippets

You can run any **JavaScript** cell by clicking the **Run Cell** button or pressing `Shift+Enter`. It will run the code as if it was a GenAID script in the workspace.
