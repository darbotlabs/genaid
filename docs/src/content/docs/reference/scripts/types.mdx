...
import src from "../../../../../../genaid/genaid.d.ts?raw"

The `genaid.d.ts` file contains the TypeScript ambient type definition
for the GenAID runtime.

<Code title="genaid.d.ts" code={src} wrap={true} lang="typescript" />