...
defined at https://github.com/darbotlabs/genaid/tree/main/packages/core/src/config.json.
...
[configuration file](/genaid/reference/configuration-files).
