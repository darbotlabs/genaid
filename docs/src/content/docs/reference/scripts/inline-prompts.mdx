...
import summaryOfSummaryPhi3 from "../../../../../../packages/sample/genaid/summary-of-summary.genai.js?raw"
...
You can use inner prompts in [tools](/genaid/reference/scripts/tools).
...
Internally, GenAID applies a concurrent limit of 8 per model by default. You can change this limit using the `modelConcurrency` option.
...
This will prevent GenAID from trying to resolve the connection information and also throw an error if you ever try to generate prompts in the main execution.
