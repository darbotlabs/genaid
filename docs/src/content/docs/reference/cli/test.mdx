...
sidebar:
  order: 3.5
description: Learn how to run tests for your scripts using GenAID CLI with
  support for multiple AI models.
keywords: CLI testing, script tests, AI model testing, test viewer, GenAID CLI
hero:
  image:
