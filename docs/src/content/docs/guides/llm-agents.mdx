...
import source from "../../../../../packages/sample/genaid/github-agent.genai.mts?raw"
import sourceMulti from "../../../../../packages/sample/genaid/agent_git_other.genai.mjs?raw"

An **[agent](/genaid/reference/scripts/agents)** is a special kind of [tool](/genaid/reference/scripts/tools) that
uses an [inline prompt](/genaid/reference/scripts/inline-prompts) and [tools](/genaid/reference/scripts/tools) to solve a task.
