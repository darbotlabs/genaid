...
keywords: [GenAID, File Safety, Automation, Scripting]
sidebar:
    order: 20
---

import { Code } from "@astrojs/starlight/components"
import src from "../../../../../packages/sample/genaid/guard.genai.mjs?raw"
...
Let's dive into the GenAID script and understand its components:
...
```js
// Use a LLM model to analyze each file for safety
...
This block uses the LLM model [ollama:llama-guard3:8b](https://ollama.com/library/llama-guard3) to analyze the contents of each file. The `prompt` function sends the file to the model, and various options are set to specify the model, label the file, and manage cache.
...
To run this script, you'll need to use the GenAID CLI. If you haven't installed it yet, follow the [installation guide](https://darbotlabs.github.io/genaid/getting-started/installation).
