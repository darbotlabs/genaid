...
import mathAgentSrc from "../../../../../packages/sample/genaid/math-agent.genai.mjs?raw"
import mathAgentSystemSrc from "../../../../../packages/sample/genaid/math-agent-system.genai.js?raw"

Using [tools (formerly functions)](/genaid/reference/scripts/tools),
...
The arithmetic question can be declared as a [script parameter](/genaid/reference/scripts/variables) to be used in the agent script.
...
The system prompt [system.math](/genaid/reference/scripts/system#systemmath)
