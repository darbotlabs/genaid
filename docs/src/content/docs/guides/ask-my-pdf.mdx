---
title: Ask My PDF
description: Quick-start guide to using GenAID for summarizing and
  critiquing PDF documents with AI assistance.
keywords: PDF analysis, AI summarization, document critique, GenAID, PDF processing
sidebar:
  order: 5
genaid:
...
The quick-start guide illustrates how to write a GenAID that takes input from a pdf file.
...
4. Replace the text `"TELL THE LLM WHAT TO DO..."` with what you want it to do with your pdf file. Use the name in the def to refer to the file.
    ...
    `
    ```
6. Right click on the pdf document in VS Code Explorer. Select **Run GenAID**. Select the script you just wrote.
