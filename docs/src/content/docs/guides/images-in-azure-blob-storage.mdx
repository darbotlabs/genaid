...
import source from "../../../../../packages/sample/genaid/azure-blobs.genai.mts?raw"
...
so that they can be set through the [cli](/genaid/reference/cli).
...
[inline prompts](/genaid/reference/scripts/inline-prompts) to split into smaller queries. (Note the use of `_.`)
