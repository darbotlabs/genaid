...
- [`deepseek` provider](/genaid/getting-started/configuration#deepseek)
...
- [`azure_ai_inference` provider](/genaid/getting-started/configuration#azure_ai_inference)
...
- [`github` provider](/genaid/getting-started/configuration#github)
