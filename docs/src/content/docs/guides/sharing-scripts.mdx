...
description: Learn how to share GenAID scripts across projects using Git repositories, submodules, and GitHub Gists.
keywords: sharing scripts, git submodules, GitHub Gists, script management, code collaboration
---
import { FileTree } from "@astrojs/starlight/components"

GenAID scripts are files and can be shared like any other code file. 

As long as the script file are under the project folder, GenAID will look for `**/*.genai.js` files and `**/*.genai.mjs`.
