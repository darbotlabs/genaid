...
In this sample, we use the `makeItBetter` function from the [GenAID runtime](/genaid/reference/scripts/runtime)
...
This line calls the `makeItBetter` function with an option to repeat the improvement process twice. It registers a [chat participant](/genaid/reference/scripts/chat-participants)
