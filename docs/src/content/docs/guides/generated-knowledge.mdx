...
keywords: AI prompting, knowledge generation, GenAID, LLM techniques, information integration
sidebar:
  order: 10
---
import { Code } from '@astrojs/starlight/components';
import importedCode from "../../../../../packages/sample/genaid/blog-generate-knowledge.genai?raw"
...
This technique can be acheived by using [runPrompt](/genaid/reference/scripts/inline-prompts)
