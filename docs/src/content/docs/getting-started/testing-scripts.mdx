...
keywords: testing, scripts, validation, GenAID CLI, automation
hero:
  image:
...
It is possible to declare [tests](/genaid/reference/scripts/tests) in the `script` function
...
- Read more about [tests](/genaid/reference/scripts/tests) in the reference.

## Next steps

[Automate](/genaid/getting-started/automating-scripts) script execution using the command line interface ([CLI](/genaid/reference/cli)).
