...
This is another instance of using the LLM to produce translation of natural strings with an embedded DSL, similarly to the [Documentation Translation](/genaid/case-studies/documentation-translations) guide.
...
The [GenAID translation](https://github.com/microsoft/pxt-jacdac/blob/45d3489c0b96ed0f74c9bbea53fb0714ae9f7fcc/buzzer/_locales/de/jacdac-buzzer-strings.json#L5) is correct.
...
The language code `langCode` is pulled from [variables](/genaid/reference/scripts/variables) `env.vars` or defaulted to `de`.
