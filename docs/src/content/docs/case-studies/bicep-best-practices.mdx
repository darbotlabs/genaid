...
import scriptSource from "../../../../../packages/sample/genaid/bicep-best-practices.genai.mjs?raw"
...
- the script uses a builtin support for [annotations](/genaid/reference/scripts/annotations) 
...
- added support to ignore false positives using the `#disable-next-line genaid`
comment
