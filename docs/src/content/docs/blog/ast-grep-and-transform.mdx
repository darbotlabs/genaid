...
tags:
  ...
  - genai
authors: pelikhan
canonical_url: https://darbotlabs.github.io/genaid/blog/ast-grep-and-transform
...
import code from "../../../../../genaid/docs.genai.mjs?raw"
import BlogNarration from "../../../components/BlogNarration.astro"

<BlogNarration />

This page describes a strategy to build GenAID scripts that use Abstract Syntax Trees (AST) to parse
...
One of the challenge when creating GenAID scripts that update source code is to correctly locate and update source code.
...
In terms of GenAID script, this means that you can build a prompt that includes as much context as you need, generate a response.
...
GenAID benefits from the excellent [Node.JS integration](https://ast-grep.github.io/reference/api.html#napi),
which is available through the [`host.astGrep()`](https://darbotlabs.github.io/genaid/reference/scripts/ast-grep) method.
...
in the [documentation](/genaid/reference/scripts/ast-grep). I encourage you to read it to dig deeper.
...
- GenAID codebase, this change also contains updates as the feature was being built.

Here it goes:

<Code code={code} lang="ts" wrap title="docs.genai.mts" />

- [original source](https://github.com/darbotlabs/genaid/blob/main/genaid/docs.genai.mts)
