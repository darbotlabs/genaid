...
tags:
  ...
  - search
  - rag
canonical_url: https://darbotlabs.github.io/genaid/blog/azure-ai-search
...
excerpt: Discover how GenAID simplifies interaction with Azure AI Search
...
GenAID provides a simple and efficient way to interact with Azure AI Search. It will handle
