...
tags:
  - openai
  - tools
canonical_url: https://darbotlabs.github.io/genaid/blog/fallback-tools
...
[Tools](/genaid/reference/scripts/tools) is a powerful feature of LLM models
...
With GenAID 1.72.0, we introduce the concept of **fallback tools**.
Basically, it consists of a [system script](/genaid/reference/scripts/system#systemtool_calls) that "teaches" the LLM model about available tools and how to call them.
