...
tags:
  ...
  - narration
  - ai
canonical_url: https://darbotlabs.github.io/genaid/blog/blog-narration
cover:
...
[See the source on GitHub.](https://github.com/darbotlabs/genaid/blob/main/docs/genaid/blog-narration.genai.mts)
...
This script uses helpers from `genaid/runtime`:
...
You can [browse the runtime source here](https://github.com/darbotlabs/genaid/blob/main/packages/cli/src/runtime.ts).
