---
title: MCP Resources
description: Learn how to publish MCP resources seamlessly using GenAID.
keywords: MCP, GenAID, resources, publishing
date: 2025-03-30
cover:
...
In a [previous post](/genaid/blog/scripts-as-mcp-tools/),
...
The rest of the MCP resource publishing process is handled by the GenAID framework.
...
- [Read the documentation](/genaid/reference/scripts/mcp-server#resources)
