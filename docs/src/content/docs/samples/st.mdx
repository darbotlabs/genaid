...
import source from "../../../../../packages/sample/genaid/samples/st.genai.mts?raw"
...
To run this script, you'll need the GenAID CLI. Check out the [installation guide](https://darbotlabs.github.io/genaid/getting-started/installation) if you need to set it up. Once you have the CLI, run the script by executing:

```bash
genaid run st
```

## Full source ([GitHub](https://github.com/darbotlabs/genaid/blob/main/packages/sample/genaid/samples/st.genai.mts))
