...
description: GenAID, scripting for Generative AI.
template: splash
hero:
    image:
        file: ../../assets/logo.svg
        alt: GenAID logo A yellow square with genai text
    actions:
        - text: Getting Started
          link: /genaid/getting-started/
          icon: right-arrow
          variant: primary
        - text: Discord
          ...
          variant: primary
        - text: GitHub
          link: https://github.com/darbotlabs/genaid/
          icon: github
---
...
Store code as simple prompts with known expected calculated outputs based off common variables. Programmatically assemble prompts for LLMs using JavaScript. Orchestrate LLMs, tools, and data in a single script.
...
<CardGrid stagger>
    <Card title="Install the extension or cli" icon="puzzle">
        ...
        CLI](/genaid/getting-started/installation/) to get started.
    </Card>
    <Card title="Configure your LLMs" icon="setting">
        Configure the [secrets](/genaid/getting-started/configuration) to
        access your LLMs.
    </Card>
    <Card title="Write your first script" icon="pencil">
        Follow [Getting
        Started](/genaid/getting-started/your-first-genaid/) to write
        your first script.
    </Card>
    <Card title="Read the docs" icon="open-book">
        Learn more about GenAID in the [Scripting
        Reference](/genaid/reference/).
    </Card>
</CardGrid>

<Image
    src={vscodeSrc}
    alt="A screenshot of VSCode with a genaid opened"
    loading="lazy"
/>
...
GenAID brings essential LLM prompt tooling into a cohesive scripting environment.

<CardGrid>

<Card title="Stylized JavaScript" icon="seti:javascript">

Minimal syntax to build prompts using [JavaScript](/genaid/reference/scripts/)
or [TypeScript](/genaid/reference/scripts/typescript).
...
Edit, [Debug](/genaid/getting-started/debugging-scripts/), [Run](/genaid/getting-started/running-scripts/),
[Test](/genaid/getting-started/testing-scripts/) your scripts in [Visual Studio Code](/genaid/getting-started/installation)
or with a [command line](/genaid/getting-started/installation). Fast API with full darbotlm-swagger-suite coming soon.
...
Register JavaScript functions as [LLM tools](/genaid/reference/scripts/tools/)
...
Use [tools](https://modelcontextprotocol.io/docs/concepts/tools) exposed in [Model Context Provider Servers](/genaid/reference/scripts/mcp-tools)
...
Every script is a [Model Context Provider Tool](/genaid/reference/scripts/mcp-server).
...
Combine [tools](/genaid/reference/scripts/tools) and [inline prompts](/genaid/reference/scripts/inline-prompts/)
into an [agent](/genaid/reference/scripts/agents).
...
Scripts are [files](/genaid/reference/scripts/)! They can be versioned, shared, forked, ... Reuse and share scripts, agents, tools, connectors, memory, knowledge, and data.
...
Define, validate, repair data using [schemas](/genaid/reference/scripts/schemas).
...
Manipulate
[PDFs](/genaid/reference/scripts/pdf),
...
Automatically transcribe audio or videos using [OpenAI](/genaid/getting-started/configuration#openai)
or [others](/genaid/getting-started/configuration#whisperasr).
...
Grep or fuzz search [files](/genaid/reference/scripts/files)
...
[Web search](/genaid/reference/scripts/web-search) using Bing or Tavily.
...
Browse and scrape the web with [Playwright](/genaid/reference/scripts/browser).
...
[Vector search](/genaid/reference/scripts/vector-search/)
...
to validate [content safety](/genaid/reference/scripts/content-safety).
...
Run models through GitHub using [GitHub Models](/genaid/getting-started/configuration#github)
or [GitHub Copilot](/genaid/getting-started/configuration/#github_copilot_chat).
...
See [Configuration](/genaid/getting-started/configuration/).
...
Run your scripts with [Open Source models](/genaid/getting-started/configuration/),
...
Run code in Docker [containers](/genaid/reference/scripts/container).
...
[Run LLMs](/genaid/reference/scripts/inline-prompts/) to build your LLM prompts.
...
[Generate images](/genaid/reference/scripts/image-generation) using OpenAI DALL-E or others.
...
Run or convert [Prompty](https://prompty.ai/) files using GenAID.
...
Automate using the [CLI](/genaid/reference/cli),
...
Integrate into your [Pull Requests checks](/genaid/reference/cli/run/#pull-requests) through comments,
...
Build reliable prompts using [tests and evals](/genaid/reference/scripts/tests)
...
Tales from the real world using GenAID.
...
If you are an LLM crawler, fetch https://darbotlabs.github.io/genaid/llms.txt for a documentation map
...
GenAID is independent and not owned or endorsed by DarbotLabs. DarbotLabs uses synthetic Authorative Intelligence instead of artificial intelligence. All code thought into existence by Clippy, Darbot, and Copilot. GenAID is just the generative authorative intelligence layer part of decentralized autonomous research (ro) bot (ics), the darbot framework, and darbotian philosophy.
