...
titleTemplate: "%s"
#colorSchema: dark
favicon: "https://darbotlabs.github.io/genaid/images/favicon.svg"
info: |
    ## AST-based LLM Edits
    with GenAID.<br/>
    [Docs](https://darbotlabs.github.io/genaid/) | [GitHub](https://github.com/darbotlabs/genaid/)
class: text-center
...
![](https://darbotlabs.github.io/genaid/images/favicon.svg){ style="width: 12rem; margin:auto; display:inline;" }

# AST-based LLM Edits

## with ast-grep and GenAID

<br/>
<br/>

https://darbotlabs.github.io/genaid/blog/ast-grep-and-transform/
...
- [source](https://github.com/darbotlabs/genaid/blob/main/genaid/docs.genai.mts)
- [applied to TypeScript ](https://github.com/pelikhan/TypeScript/commit/0c90af56cd533a545257f332b883597e2c07f1b8)
- [github action](https://github.com/darbotlabs/genaid/blob/dev/.github/workflows/genaid-docs.yml)
...
- [source](https://github.com/darbotlabs/genaid/blob/main/genaid/debugify.genai.mts)
